							...
							<div class="single-footer br-2 xs-mb">
								...
								<div class="footer-mid-menu">
									<ul>
										...
										<li><a href="nhac.html">Nghe nhạc</a></li>
										<li><a href="https://metruyencv.com/truyen/huyen-huyen-nguyen-lai-ta-la-tuyet-the-vo-than">Truyện chữ</a></li>
										<li><a href="chungkhoan.html">Chứng khoán</a></li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="single-footer mrg-sm">
						...
						<div class="footer-contact">
							<p class="adress">
								<span>12 Nam Tu Liem</span>
								Ha Noi, Viet Nam
							</p>
							<p><span>Call us now:</span> (+84) 982645294</p>
							<p><span>Email:</span> mailgg102@gmail.com</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row bt-2">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="copy-right-area">
						<p>Copyright ©<a href="#">12book12</a>. All Right Reserved.</p>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<!-- Mirrored from demo.devitems.com/koparion-v2/koparion/index-4.html by HTTrack Website Copier/3.x [XR&CO'2012], 20/11/2022 12:12:12 GMT -->
